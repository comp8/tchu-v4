...
export async function fetchUsers({ ids, logins, access_token, clientId }: IFetchUsersOptions): Promise<ITwitchUserResponse> {
...
export async function fetchUsersFollows({ from_id, to_id, after, first, access_token, clientId }: IFetchUsersFollowsOptions): Promise<ITwitchUserFollowsResponse> {
